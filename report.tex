...
本地仓库的 \texttt{git log --oneline} 真实输出如下（由新到旧）：
\begin{lstlisting}[language=bash]
e7c2d91 docs(report): embed screenshots and finalize week4 report
b41f8a0 chore: add terminal screenshot generator + 8 PNGs
d09c1e3 docs: add 14 after-class exercises
f3a6b50 feat(q16): fix greeting, make check/build, sha256, focused commit
a1e8c74 feat(q15): curl + jq -> summary.md
7c2d0bb feat(q14): make build system (incremental rebuild)
5e9a1f3 feat(q13): local quality gate (ruff + pytest + check.sh)
